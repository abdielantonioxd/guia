...
BEGIN
    ...
    ELSE
   UPDATE establecimientoservicio  SET servicios = _subService,  servicioPrincipal = _servicePrincipal  WHERE establecimientID = _idService ;
...
-- Dump completed on 2019-08-30 13:45:01
